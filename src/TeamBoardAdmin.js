...
const TeamBoardAdmin = ({selectedBackground}) => {
    const navigate = useNavigate();

    return (
        <div className="team-board-container">
            <div className = "admin-team-board-box">
                <h1>Team Board</h1>
                <p>Admin Action:</p>
                <button onClick={() =>  navigate('/TeamDashBoard')}>Team Dashboard</button>
                <button onClick={() =>  navigate('/CreateManageTeam')}>Create & Manage Team</button>
            </div>
