...
const CreateManageTeam = ({selectedBackground}) => {
    const navigate = useNavigate();

    return (
        <div className="create-manage-team-container">
            <div className="create-manage-team-box">
                <h1>Team Board:</h1>
                <p>Create & Manage Team:</p>
                <button onClick={() => navigate('/AddMemberTeamBoard')}>Add Member to Project</button>
                <button onClick={() => navigate('/RemoveMemberTeamBoard')}>Remove Member to Project</button>
            </div>
