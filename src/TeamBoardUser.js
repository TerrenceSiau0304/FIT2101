...
const TeamBoardUser = ({selectedBackground}) => {
    const navigate = useNavigate();

    return (
        <div className="team-board-container">
            <div className = "user-team-board-box">
                <h1>Team Board</h1>
                <p>User Action:</p>
                <button onClick={() =>  navigate('/MemberDashBoard')}>Member Dashboard</button>
                <button onClick={() =>  navigate('/UserResetPassword')}>Reset Password</button>
            </div>
